...
const BUTTONS: { label: string; key: ModalKey; style: string }[] = [
  {
    ...
    key: "delegate",
    style: "bg-cyan-500 hover:bg-cyan-600 text-white shadow-lg shadow-cyan-500/30",
  },
  {
  ...
  },
  {
    ...
    key: "brochure",
    style: "bg-transparent border border-cyan-400 text-cyan-400 hover:bg-cyan-400/10",
  },
];
